...
//接口用例
  ...
  TEST_PLAN_FUNCTION_TEST_CASE: [
    {id: 'customNum', key: '1', label: i18n.t('commons.id')},
    {id: 'name', key: '2', label: i18n.t('commons.name')},
    {id: 'priority', key: '3', label: i18n.t('test_track.case.priority')},
    {id: 'tags', key: '4', label: i18n.t('commons.tag')},
    {id: 'nodePath', key: '5', label: i18n.t('test_track.case.module')},
    {id: 'projectName', key: '6', label: i18n.t('test_track.review.review_project')},
    {id: 'issuesContent', key: '7', label: i18n.t('test_track.issue.issue')},
    {id: 'executorName', key: '8', label: i18n.t('test_track.plan_view.executor')},
    {id: 'status', key: '9', label: i18n.t('test_track.plan_view.execute_result')},
    {id: 'updateTime', key: 'a', label: i18n.t('commons.update_time')},
    {id: 'maintainer', key: 'b', label: i18n.t('api_test.definition.request.responsible')},
  ...
  TEST_PLAN_API_CASE: [
    ...
    {id: 'execResult', key: '8', label: i18n.t('test_track.plan.load_case.execution_status')},
